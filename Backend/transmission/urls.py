...
urlpatterns = [
    ...
    path("get_current_downloads/", Current_Torrents_Downloads.as_view(), name="current_torrent_downloads"),
    path("get_current_transfers/", Current_File_Transfers.as_view(), name="current file transfers"),
